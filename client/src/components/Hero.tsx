...
import portrait from "@assets/generated_images/reverend_portrait.png";
      ...
      <div className="container relative z-10 px-4 mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Button size="lg" variant="outline" className="rounded-full px-8 h-12 text-base group">
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="relative z-10 rounded-2xl overflow-hidden shadow-2xl border-4 border-white/20 aspect-[4/5] max-w-md mx-auto">
            <img
              src={portrait}
              alt="Rev. Tom Otieno"
