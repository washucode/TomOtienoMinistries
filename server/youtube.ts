...
function categorizeVideo(title: string): string {
  ...
  if (lowerTitle.includes("deliverance") || lowerTitle.includes("unmask") || lowerTitle.includes("soul ties") || lowerTitle.includes("curse") || lowerTitle.includes("spiritual warfare")) {
    return "Deliverance";
  }
  if (lowerTitle.includes("healing") || lowerTitle.includes("trauma") || lowerTitle.includes("rejection") || lowerTitle.includes("emotional")) {
    return "Healing";
  }
  if (lowerTitle.includes("family") || lowerTitle.includes("marriage") || lowerTitle.includes("parenting") || lowerTitle.includes("husband") || lowerTitle.includes("wife")) {
    return "Family";
  }
  if (lowerTitle.includes("sermon") || lowerTitle.includes("sunday") || lowerTitle.includes("service")) {
    return "Sermon";
  }
  if (lowerTitle.includes("worship") || lowerTitle.includes("proskuneo") || lowerTitle.includes("praise")) {
    return "Worship";
  }
  if (lowerTitle.includes("church") || lowerTitle.includes("congregation")) {
    return "Church";
  }
